  ...
  return (
    <Layout>
      <div className="relative">
        <MatrixRain />
        <section className="relative z-10 p-8 max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12">
          {/* Hero Section */}
          ...
          {/* Texto com animação */}
          <div className="relative z-10 w-full md:w-2/3 text-center text-white">
